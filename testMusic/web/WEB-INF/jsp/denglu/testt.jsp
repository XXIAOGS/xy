...
<body>
<div id="toubu">
    <div class="div_01">小小音乐  用户：${user.username}

<%--        <input type="text" value="${ct.username}" name="username" class="i1" style="text-align: right"  stydisabled disabled>--%>
<%--        <p></p>--%>
        <br></div>
    <div class="toubuuu">音乐查询:<form action="${pageContext.request.contextPath}/music/toId?id=${user.id}" method="post">
    <input type="musicName" class="submit" name="musicName" placeholder="请输入歌曲名称"><input class="submit" type="submit" value="查询">
